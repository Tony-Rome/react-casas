        ...
        <div className='card'>
            ...
            <div className='row'>
                <div className='col-2-of-3'>
                    ...
                    <p className='card__info'>Bedrooms: ${numberWithCommas(props.bedrooms)}</p>
                    <p className='card__info'>Bathrooms: ${numberWithCommas(props.bathrooms)}</p>
                </div>
            ...
            <Link className='card__link' to={`/listings/${props.slug}`}>View listings</Link>
        </div>
    );
};
