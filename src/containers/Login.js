...
const Login = ({ login, isAuthenticated})  => {
   ...
   return (
       <div className='auth'>
        <Helmet>
            <title>Ealest Estate - Login</title>
            <meta
                name='description'
                content='login page'
            />
        ...
        <p className='auth__lead'>Sign into ur account</p>
        ...
        <p className='auth__authtext'>
            No tienes cuenta? <Link className='auth__authtext__link' to='/signup'>Sign up</Link>
        </p>
       </div>
   );
